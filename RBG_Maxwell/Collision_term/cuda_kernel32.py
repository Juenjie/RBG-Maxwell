...
def accumulate_collision_term(f_x_p_t0level, f_x_p_tilevel, 
                    m1_squared, k1x, k1y, k1z, k10, m2_squared, 
                    m3_squared, k3x, k3y, k3z, k30, 
                    m4_squared, k4x, k4y, k4z,
    ...
    # k4z must be in the momentum box range of particle type 0 
    if k4z > -half_pz[flavor[i_collision,3]] and k4z < half_pz[flavor[i_collision,3]]:
        ...
        if (k2x > -half_px[flavor[i_collision,1]] and k2x < half_px[flavor[i_collision,1]] and 
            ...
            if abs(k10+k20+k30-k40-p0) < 10**(-18):
                ...
                if Ja>1e-5 and momentum_product > 10**(-13):
                    ...
                    # f1*f2*f3*tf4*tfp - tf1*tf2*f3*f4*fp
...
@cuda.jit(device=True)
def H_fun(k10,k1x,k1y,k1z,m2,k30,k3x,k3y,k3z,m4,k4x,k4y,p0,px,py,pz,c):
    return ((-4*k10**2*k1z + 4*k1x**2*k1z + 4*k1y**2*k1z + 4*k1z**3 - 8*k10*k1z*k30 - 4*k1z*k30**2 + 8*k1x*k1z*k3x + 4*k1z*k3x**2 + 8*k1y*k1z*k3y + 4*k1z*k3y**2 - 4*k10**2*k3z + 4*k1x**2*k3z + 4*k1y**2*k3z + 12*k1z**2*k3z - 8*k10*k30*k3z - 4*k30**2*k3z + 8*k1x*k3x*k3z + 4*k3x**2*k3z + 8*k1y*k3y*k3z + 4*k3y**2*k3z + 12*k1z*k3z**2 + 4*k3z**3 - 8*k1x*k1z*k4x - 8*k1z*k3x*k4x - 8*k1x*k3z*k4x - 8*k3x*k3z*k4x - 8*k1y*k1z*k4y - 8*k1z*k3y*k4y - 8*k1y*k3z*k4y - 8*k3y*k3z*k4y + 4*c**2*k1z*m2**2 + 4*c**2*k3z*m2**2 - 4*c**2*k1z*m4**2 - 4*c**2*k3z*m4**2 + 8*k10*k1z*p0 + 8*k1z*k30*p0 + 8*k10*k3z*p0 + 8*k30*k3z*p0 - 4*k1z*p0**2 - 4*k3z*p0**2 - 8*k1x*k1z*px - 8*k1z*k3x*px - 8*k1x*k3z*px - 8*k3x*k3z*px + 8*k1z*k4x*px + 8*k3z*k4x*px + 4*k1z*px**2 + 4*k3z*px**2 - 8*k1y*k1z*py - 8*k1z*k3y*py - 8*k1y*k3z*py - 8*k3y*k3z*py + 8*k1z*k4y*py + 8*k3z*k4y*py + 4*k1z*py**2 + 4*k3z*py**2 + 4*k10**2*pz - 4*k1x**2*pz - 4*k1y**2*pz - 12*k1z**2*pz + 8*k10*k30*pz + 4*k30**2*pz - 8*k1x*k3x*pz - 4*k3x**2*pz - 8*k1y*k3y*pz - 4*k3y**2*pz - 24*k1z*k3z*pz - 12*k3z**2*pz + 8*k1x*k4x*pz + 8*k3x*k4x*pz + 8*k1y*k4y*pz + 8*k3y*k4y*pz - 4*c**2*m2**2*pz + 4*c**2*m4**2*pz - 8*k10*p0*pz - 8*k30*p0*pz + 4*p0**2*pz + 8*k1x*px*pz + 8*k3x*px*pz - 8*k4x*px*pz - 4*px**2*pz + 8*k1y*py*pz + 8*k3y*py*pz - 8*k4y*py*pz - 4*py**2*pz + 12*k1z*pz**2 + 12*k3z*pz**2 - 4*pz**3)**2 - 4*(4*k10**2 - 4*k1z**2 + 8*k10*k30 + 4*k30**2 - 8*k1z*k3z - 4*k3z**2 - 8*k10*p0 - 8*k30*p0 + 4*p0**2 + 8*k1z*pz + 8*k3z*pz - 4*pz**2)*(-k10**4 + 2*k10**2*k1x**2 - k1x**4 + 2*k10**2*k1y**2 - 2*k1x**2*k1y**2 - k1y**4 + 2*k10**2*k1z**2 - 2*k1x**2*k1z**2 - 2*k1y**2*k1z**2 - k1z**4 - 4*k10**3*k30 + 4*k10*k1x**2*k30 + 4*k10*k1y**2*k30 + 4*k10*k1z**2*k30 - 6*k10**2*k30**2 + 2*k1x**2*k30**2 + 2*k1y**2*k30**2 + 2*k1z**2*k30**2 - 4*k10*k30**3 - k30**4 + 4*k10**2*k1x*k3x - 4*k1x**3*k3x - 4*k1x*k1y**2*k3x - 4*k1x*k1z**2*k3x + 8*k10*k1x*k30*k3x + 4*k1x*k30**2*k3x + 2*k10**2*k3x**2 - 6*k1x**2*k3x**2 - 2*k1y**2*k3x**2 - 2*k1z**2*k3x**2 + 4*k10*k30*k3x**2 + 2*k30**2*k3x**2 - 4*k1x*k3x**3 - k3x**4 + 4*k10**2*k1y*k3y - 4*k1x**2*k1y*k3y - 4*k1y**3*k3y - 4*k1y*k1z**2*k3y + 8*k10*k1y*k30*k3y + 4*k1y*k30**2*k3y - 8*k1x*k1y*k3x*k3y - 4*k1y*k3x**2*k3y + 2*k10**2*k3y**2 - 2*k1x**2*k3y**2 - 6*k1y**2*k3y**2 - 2*k1z**2*k3y**2 + 4*k10*k30*k3y**2 + 2*k30**2*k3y**2 - 4*k1x*k3x*k3y**2 - 2*k3x**2*k3y**2 - 4*k1y*k3y**3 - k3y**4 + 4*k10**2*k1z*k3z - 4*k1x**2*k1z*k3z - 4*k1y**2*k1z*k3z - 4*k1z**3*k3z + 8*k10*k1z*k30*k3z + 4*k1z*k30**2*k3z - 8*k1x*k1z*k3x*k3z - 4*k1z*k3x**2*k3z - 8*k1y*k1z*k3y*k3z - 4*k1z*k3y**2*k3z + 2*k10**2*k3z**2 - 2*k1x**2*k3z**2 - 2*k1y**2*k3z**2 - 6*k1z**2*k3z**2 + 4*k10*k30*k3z**2 + 2*k30**2*k3z**2 - 4*k1x*k3x*k3z**2 - 2*k3x**2*k3z**2 - 4*k1y*k3y*k3z**2 - 2*k3y**2*k3z**2 - 4*k1z*k3z**3 - k3z**4 - 4*k10**2*k1x*k4x + 4*k1x**3*k4x + 4*k1x*k1y**2*k4x + 4*k1x*k1z**2*k4x - 8*k10*k1x*k30*k4x - 4*k1x*k30**2*k4x - 4*k10**2*k3x*k4x + 12*k1x**2*k3x*k4x + 4*k1y**2*k3x*k4x + 4*k1z**2*k3x*k4x - 8*k10*k30*k3x*k4x - 4*k30**2*k3x*k4x + 12*k1x*k3x**2*k4x + 4*k3x**3*k4x + 8*k1x*k1y*k3y*k4x + 8*k1y*k3x*k3y*k4x + 4*k1x*k3y**2*k4x + 4*k3x*k3y**2*k4x + 8*k1x*k1z*k3z*k4x + 8*k1z*k3x*k3z*k4x + 4*k1x*k3z**2*k4x + 4*k3x*k3z**2*k4x + 4*k10**2*k4x**2 - 4*k1x**2*k4x**2 + 8*k10*k30*k4x**2 + 4*k30**2*k4x**2 - 8*k1x*k3x*k4x**2 - 4*k3x**2*k4x**2 - 4*k10**2*k1y*k4y + 4*k1x**2*k1y*k4y + 4*k1y**3*k4y + 4*k1y*k1z**2*k4y - 8*k10*k1y*k30*k4y - 4*k1y*k30**2*k4y + 8*k1x*k1y*k3x*k4y + 4*k1y*k3x**2*k4y - 4*k10**2*k3y*k4y + 4*k1x**2*k3y*k4y + 12*k1y**2*k3y*k4y + 4*k1z**2*k3y*k4y - 8*k10*k30*k3y*k4y - 4*k30**2*k3y*k4y + 8*k1x*k3x*k3y*k4y + 4*k3x**2*k3y*k4y + 12*k1y*k3y**2*k4y + 4*k3y**3*k4y + 8*k1y*k1z*k3z*k4y + 8*k1z*k3y*k3z*k4y + 4*k1y*k3z**2*k4y + 4*k3y*k3z**2*k4y - 8*k1x*k1y*k4x*k4y - 8*k1y*k3x*k4x*k4y - 8*k1x*k3y*k4x*k4y - 8*k3x*k3y*k4x*k4y + 4*k10**2*k4y**2 - 4*k1y**2*k4y**2 + 8*k10*k30*k4y**2 + 4*k30**2*k4y**2 - 8*k1y*k3y*k4y**2 - 4*k3y**2*k4y**2 + 2*c**2*k10**2*m2**2 - 2*c**2*k1x**2*m2**2 - 2*c**2*k1y**2*m2**2 - 2*c**2*k1z**2*m2**2 + 4*c**2*k10*k30*m2**2 + 2*c**2*k30**2*m2**2 - 4*c**2*k1x*k3x*m2**2 - 2*c**2*k3x**2*m2**2 - 4*c**2*k1y*k3y*m2**2 - 2*c**2*k3y**2*m2**2 - 4*c**2*k1z*k3z*m2**2 - 2*c**2*k3z**2*m2**2 + 4*c**2*k1x*k4x*m2**2 + 4*c**2*k3x*k4x*m2**2 + 4*c**2*k1y*k4y*m2**2 + 4*c**2*k3y*k4y*m2**2 - c**4*m2**4 + 2*c**2*k10**2*m4**2 + 2*c**2*k1x**2*m4**2 + 2*c**2*k1y**2*m4**2 + 2*c**2*k1z**2*m4**2 + 4*c**2*k10*k30*m4**2 + 2*c**2*k30**2*m4**2 + 4*c**2*k1x*k3x*m4**2 + 2*c**2*k3x**2*m4**2 + 4*c**2*k1y*k3y*m4**2 + 2*c**2*k3y**2*m4**2 + 4*c**2*k1z*k3z*m4**2 + 2*c**2*k3z**2*m4**2 - 4*c**2*k1x*k4x*m4**2 - 4*c**2*k3x*k4x*m4**2 - 4*c**2*k1y*k4y*m4**2 - 4*c**2*k3y*k4y*m4**2 + 2*c**4*m2**2*m4**2 - c**4*m4**4 + 4*k10**3*p0 - 4*k10*k1x**2*p0 - 4*k10*k1y**2*p0 - 4*k10*k1z**2*p0 + 12*k10**2*k30*p0 - 4*k1x**2*k30*p0 - 4*k1y**2*k30*p0 - 4*k1z**2*k30*p0 + 12*k10*k30**2*p0 + 4*k30**3*p0 - 8*k10*k1x*k3x*p0 - 8*k1x*k30*k3x*p0 - 4*k10*k3x**2*p0 - 4*k30*k3x**2*p0 - 8*k10*k1y*k3y*p0 - 8*k1y*k30*k3y*p0 - 4*k10*k3y**2*p0 - 4*k30*k3y**2*p0 - 8*k10*k1z*k3z*p0 - 8*k1z*k30*k3z*p0 - 4*k10*k3z**2*p0 - 4*k30*k3z**2*p0 + 8*k10*k1x*k4x*p0 + 8*k1x*k30*k4x*p0 + 8*k10*k3x*k4x*p0 + 8*k30*k3x*k4x*p0 - 8*k10*k4x**2*p0 - 8*k30*k4x**2*p0 + 8*k10*k1y*k4y*p0 + 8*k1y*k30*k4y*p0 + 8*k10*k3y*k4y*p0 + 8*k30*k3y*k4y*p0 - 8*k10*k4y**2*p0 - 8*k30*k4y**2*p0 - 4*c**2*k10*m2**2*p0 - 4*c**2*k30*m2**2*p0 - 4*c**2*k10*m4**2*p0 - 4*c**2*k30*m4**2*p0 - 6*k10**2*p0**2 + 2*k1x**2*p0**2 + 2*k1y**2*p0**2 + 2*k1z**2*p0**2 - 12*k10*k30*p0**2 - 6*k30**2*p0**2 + 4*k1x*k3x*p0**2 + 2*k3x**2*p0**2 + 4*k1y*k3y*p0**2 + 2*k3y**2*p0**2 + 4*k1z*k3z*p0**2 + 2*k3z**2*p0**2 - 4*k1x*k4x*p0**2 - 4*k3x*k4x*p0**2 + 4*k4x**2*p0**2 - 4*k1y*k4y*p0**2 - 4*k3y*k4y*p0**2 + 4*k4y**2*p0**2 + 2*c**2*m2**2*p0**2 + 2*c**2*m4**2*p0**2 + 4*k10*p0**3 + 4*k30*p0**3 - p0**4 - 4*k10**2*k1x*px + 4*k1x**3*px + 4*k1x*k1y**2*px + 4*k1x*k1z**2*px - 8*k10*k1x*k30*px - 4*k1x*k30**2*px - 4*k10**2*k3x*px + 12*k1x**2*k3x*px + 4*k1y**2*k3x*px + 4*k1z**2*k3x*px - 8*k10*k30*k3x*px - 4*k30**2*k3x*px + 12*k1x*k3x**2*px + 4*k3x**3*px + 8*k1x*k1y*k3y*px + 8*k1y*k3x*k3y*px + 4*k1x*k3y**2*px + 4*k3x*k3y**2*px + 8*k1x*k1z*k3z*px + 8*k1z*k3x*k3z*px + 4*k1x*k3z**2*px + 4*k3x*k3z**2*px + 4*k10**2*k4x*px - 12*k1x**2*k4x*px - 4*k1y**2*k4x*px - 4*k1z**2*k4x*px + 8*k10*k30*k4x*px + 4*k30**2*k4x*px - 24*k1x*k3x*k4x*px - 12*k3x**2*k4x*px - 8*k1y*k3y*k4x*px - 4*k3y**2*k4x*px - 8*k1z*k3z*k4x*px - 4*k3z**2*k4x*px + 8*k1x*k4x**2*px + 8*k3x*k4x**2*px - 8*k1x*k1y*k4y*px - 8*k1y*k3x*k4y*px - 8*k1x*k3y*k4y*px - 8*k3x*k3y*k4y*px + 8*k1y*k4x*k4y*px + 8*k3y*k4x*k4y*px + 4*c**2*k1x*m2**2*px + 4*c**2*k3x*m2**2*px - 4*c**2*k4x*m2**2*px - 4*c**2*k1x*m4**2*px - 4*c**2*k3x*m4**2*px + 4*c**2*k4x*m4**2*px + 8*k10*k1x*p0*px + 8*k1x*k30*p0*px + 8*k10*k3x*p0*px + 8*k30*k3x*p0*px - 8*k10*k4x*p0*px - 8*k30*k4x*p0*px - 4*k1x*p0**2*px - 4*k3x*p0**2*px + 4*k4x*p0**2*px + 2*k10**2*px**2 - 6*k1x**2*px**2 - 2*k1y**2*px**2 - 2*k1z**2*px**2 + 4*k10*k30*px**2 + 2*k30**2*px**2 - 12*k1x*k3x*px**2 - 6*k3x**2*px**2 - 4*k1y*k3y*px**2 - 2*k3y**2*px**2 - 4*k1z*k3z*px**2 - 2*k3z**2*px**2 + 12*k1x*k4x*px**2 + 12*k3x*k4x*px**2 - 4*k4x**2*px**2 + 4*k1y*k4y*px**2 + 4*k3y*k4y*px**2 - 2*c**2*m2**2*px**2 + 2*c**2*m4**2*px**2 - 4*k10*p0*px**2 - 4*k30*p0*px**2 + 2*p0**2*px**2 + 4*k1x*px**3 + 4*k3x*px**3 - 4*k4x*px**3 - px**4 - 4*k10**2*k1y*py + 4*k1x**2*k1y*py + 4*k1y**3*py + 4*k1y*k1z**2*py - 8*k10*k1y*k30*py - 4*k1y*k30**2*py + 8*k1x*k1y*k3x*py + 4*k1y*k3x**2*py - 4*k10**2*k3y*py + 4*k1x**2*k3y*py + 12*k1y**2*k3y*py + 4*k1z**2*k3y*py - 8*k10*k30*k3y*py - 4*k30**2*k3y*py + 8*k1x*k3x*k3y*py + 4*k3x**2*k3y*py + 12*k1y*k3y**2*py + 4*k3y**3*py + 8*k1y*k1z*k3z*py + 8*k1z*k3y*k3z*py + 4*k1y*k3z**2*py + 4*k3y*k3z**2*py - 8*k1x*k1y*k4x*py - 8*k1y*k3x*k4x*py - 8*k1x*k3y*k4x*py - 8*k3x*k3y*k4x*py + 4*k10**2*k4y*py - 4*k1x**2*k4y*py - 12*k1y**2*k4y*py - 4*k1z**2*k4y*py + 8*k10*k30*k4y*py + 4*k30**2*k4y*py - 8*k1x*k3x*k4y*py - 4*k3x**2*k4y*py - 24*k1y*k3y*k4y*py - 12*k3y**2*k4y*py - 8*k1z*k3z*k4y*py - 4*k3z**2*k4y*py + 8*k1x*k4x*k4y*py + 8*k3x*k4x*k4y*py + 8*k1y*k4y**2*py + 8*k3y*k4y**2*py + 4*c**2*k1y*m2**2*py + 4*c**2*k3y*m2**2*py - 4*c**2*k4y*m2**2*py - 4*c**2*k1y*m4**2*py - 4*c**2*k3y*m4**2*py + 4*c**2*k4y*m4**2*py + 8*k10*k1y*p0*py + 8*k1y*k30*p0*py + 8*k10*k3y*p0*py + 8*k30*k3y*p0*py - 8*k10*k4y*p0*py - 8*k30*k4y*p0*py - 4*k1y*p0**2*py - 4*k3y*p0**2*py + 4*k4y*p0**2*py - 8*k1x*k1y*px*py - 8*k1y*k3x*px*py - 8*k1x*k3y*px*py - 8*k3x*k3y*px*py + 8*k1y*k4x*px*py + 8*k3y*k4x*px*py + 8*k1x*k4y*px*py + 8*k3x*k4y*px*py - 8*k4x*k4y*px*py + 4*k1y*px**2*py + 4*k3y*px**2*py - 4*k4y*px**2*py + 2*k10**2*py**2 - 2*k1x**2*py**2 - 6*k1y**2*py**2 - 2*k1z**2*py**2 + 4*k10*k30*py**2 + 2*k30**2*py**2 - 4*k1x*k3x*py**2 - 2*k3x**2*py**2 - 12*k1y*k3y*py**2 - 6*k3y**2*py**2 - 4*k1z*k3z*py**2 - 2*k3z**2*py**2 + 4*k1x*k4x*py**2 + 4*k3x*k4x*py**2 + 12*k1y*k4y*py**2 + 12*k3y*k4y*py**2 - 4*k4y**2*py**2 - 2*c**2*m2**2*py**2 + 2*c**2*m4**2*py**2 - 4*k10*p0*py**2 - 4*k30*p0*py**2 + 2*p0**2*py**2 + 4*k1x*px*py**2 + 4*k3x*px*py**2 - 4*k4x*px*py**2 - 2*px**2*py**2 + 4*k1y*py**3 + 4*k3y*py**3 - 4*k4y*py**3 - py**4 - 4*k10**2*k1z*pz + 4*k1x**2*k1z*pz + 4*k1y**2*k1z*pz + 4*k1z**3*pz - 8*k10*k1z*k30*pz - 4*k1z*k30**2*pz + 8*k1x*k1z*k3x*pz + 4*k1z*k3x**2*pz + 8*k1y*k1z*k3y*pz + 4*k1z*k3y**2*pz - 4*k10**2*k3z*pz + 4*k1x**2*k3z*pz + 4*k1y**2*k3z*pz + 12*k1z**2*k3z*pz - 8*k10*k30*k3z*pz - 4*k30**2*k3z*pz + 8*k1x*k3x*k3z*pz + 4*k3x**2*k3z*pz + 8*k1y*k3y*k3z*pz + 4*k3y**2*k3z*pz + 12*k1z*k3z**2*pz + 4*k3z**3*pz - 8*k1x*k1z*k4x*pz - 8*k1z*k3x*k4x*pz - 8*k1x*k3z*k4x*pz - 8*k3x*k3z*k4x*pz - 8*k1y*k1z*k4y*pz - 8*k1z*k3y*k4y*pz - 8*k1y*k3z*k4y*pz - 8*k3y*k3z*k4y*pz + 4*c**2*k1z*m2**2*pz + 4*c**2*k3z*m2**2*pz - 4*c**2*k1z*m4**2*pz - 4*c**2*k3z*m4**2*pz + 8*k10*k1z*p0*pz + 8*k1z*k30*p0*pz + 8*k10*k3z*p0*pz + 8*k30*k3z*p0*pz - 4*k1z*p0**2*pz - 4*k3z*p0**2*pz - 8*k1x*k1z*px*pz - 8*k1z*k3x*px*pz - 8*k1x*k3z*px*pz - 8*k3x*k3z*px*pz + 8*k1z*k4x*px*pz + 8*k3z*k4x*px*pz + 4*k1z*px**2*pz + 4*k3z*px**2*pz - 8*k1y*k1z*py*pz - 8*k1z*k3y*py*pz - 8*k1y*k3z*py*pz - 8*k3y*k3z*py*pz + \
    8*k1z*k4y*py*pz + 8*k3z*k4y*py*pz + 4*k1z*py**2*pz + 4*k3z*py**2*pz + 2*k10**2*pz**2 - 2*k1x**2*pz**2 - 2*k1y**2*pz**2 - 6*k1z**2*pz**2 + 4*k10*k30*pz**2 + 2*k30**2*pz**2 - 4*k1x*k3x*pz**2 - 2*k3x**2*pz**2 - 4*k1y*k3y*pz**2 - 2*k3y**2*pz**2 - 12*k1z*k3z*pz**2 - 6*k3z**2*pz**2 + 4*k1x*k4x*pz**2 + 4*k3x*k4x*pz**2 + 4*k1y*k4y*pz**2 + 4*k3y*k4y*pz**2 - 2*c**2*m2**2*pz**2 + 2*c**2*m4**2*pz**2 - 4*k10*p0*pz**2 - 4*k30*p0*pz**2 + 2*p0**2*pz**2 + 4*k1x*px*pz**2 + 4*k3x*px*pz**2 - 4*k4x*px*pz**2 - 2*px**2*pz**2 + 4*k1y*py*pz**2 + 4*k3y*py*pz**2 - 4*k4y*py*pz**2 - 2*py**2*pz**2 + 4*k1z*pz**3 + 4*k3z*pz**3 - pz**4))

@cuda.jit(device=True)
def C1_fun(k10,k1x,k1y,k1z,m2,k30,k3x,k3y,k3z,m4,k4x,k4y,p0,px,py,pz,c):
    return 4*k10**2*k1z - 4*k1x**2*k1z - 4*k1y**2*k1z - 4*k1z**3 + 8*k10*k1z*k30 + 4*k1z*k30**2 - 8*k1x*k1z*k3x - 4*k1z*k3x**2 - 8*k1y*k1z*k3y - 4*k1z*k3y**2 + 4*k10**2*k3z - 4*k1x**2*k3z - 4*k1y**2*k3z - 12*k1z**2*k3z + 8*k10*k30*k3z + 4*k30**2*k3z - 8*k1x*k3x*k3z - 4*k3x**2*k3z - 8*k1y*k3y*k3z - 4*k3y**2*k3z - 12*k1z*k3z**2 - 4*k3z**3 + 8*k1x*k1z*k4x + 8*k1z*k3x*k4x + 8*k1x*k3z*k4x + 8*k3x*k3z*k4x + 8*k1y*k1z*k4y + 8*k1z*k3y*k4y + 8*k1y*k3z*k4y + 8*k3y*k3z*k4y - 4*c**2*k1z*m2**2 - 4*c**2*k3z*m2**2 + 4*c**2*k1z*m4**2 + 4*c**2*k3z*m4**2 - 8*k10*k1z*p0 - 8*k1z*k30*p0 - 8*k10*k3z*p0 - 8*k30*k3z*p0 + 4*k1z*p0**2 + 4*k3z*p0**2 + 8*k1x*k1z*px + 8*k1z*k3x*px + 8*k1x*k3z*px + 8*k3x*k3z*px - 8*k1z*k4x*px - 8*k3z*k4x*px - 4*k1z*px**2 - 4*k3z*px**2 + 8*k1y*k1z*py + 8*k1z*k3y*py + 8*k1y*k3z*py + 8*k3y*k3z*py - 8*k1z*k4y*py - 8*k3z*k4y*py - 4*k1z*py**2 - 4*k3z*py**2 - 4*k10**2*pz + 4*k1x**2*pz + 4*k1y**2*pz + 12*k1z**2*pz - 8*k10*k30*pz - 4*k30**2*pz + 8*k1x*k3x*pz + 4*k3x**2*pz + 8*k1y*k3y*pz + 4*k3y**2*pz + 24*k1z*k3z*pz + 12*k3z**2*pz - 8*k1x*k4x*pz - 8*k3x*k4x*pz - 8*k1y*k4y*pz - 8*k3y*k4y*pz + 4*c**2*m2**2*pz - 4*c**2*m4**2*pz + 8*k10*p0*pz + 8*k30*p0*pz - 4*p0**2*pz - 8*k1x*px*pz - 8*k3x*px*pz + 8*k4x*px*pz + 4*px**2*pz - 8*k1y*py*pz - 8*k3y*py*pz + 8*k4y*py*pz + 4*py**2*pz - 12*k1z*pz**2 - 12*k3z*pz**2 + 4*pz**3

@cuda.jit(device=True)
def C2_fun(k10,k1x,k1y,k1z,m2,k30,k3x,k3y,k3z,m4,k4x,k4y,p0,px,py,pz,c):
    return 2.*(4*k10**2 - 4*k1z**2 + 8*k10*k30 + 4*k30**2 - 8*k1z*k3z - 4*k3z**2 - 8*k10*p0 - 8*k30*p0 + 4*p0**2 + 8*k1z*pz + 8*k3z*pz - 4*pz**2)
