        ...
        for i_grid_s in range(total_grid_s):
            ...
            if dr > 10**(-18):                            
                ...
                if rtime_i < -0.5:
                    ...
                    distance_r = cuda.local.array(shape=3, dtype=float64)  
                    if dr < 10**(-18):
                        distance_r[0] = 0.
                    else:
                        distance_r[0] = 1/dr
                    ...
                    Jefi_terms = cuda.local.array(shape=15, dtype=float64)  
#                     Jefi_terms[0] = (x_o-x_s)/dr**3*rho_s
                    Jefi_terms[0] = (x_o-x_s)*distance_r[2]*rho_s
#                     Jefi_terms[1] = (x_o-x_s)/dr**2/c*prho_pt_s
                    Jefi_terms[1] = (x_o-x_s)*distance_r[1]/c*prho_pt_s
#                     Jefi_terms[2] = -1/dr/c**2*pJx_pt_s
                    Jefi_terms[2] = -distance_r[0]/c**2*pJx_pt_s
#                     Jefi_terms[3] = (y_o-y_s)/dr**3*rho_s
                    Jefi_terms[3] = (y_o-y_s)*distance_r[2]*rho_s
#                     Jefi_terms[4] = (y_o-y_s)/dr**2/c*prho_pt_s
                    Jefi_terms[4] = (y_o-y_s)*distance_r[1]/c*prho_pt_s
#                     Jefi_terms[5] = -1/dr/c**2*pJy_pt_s
                    Jefi_terms[5] = -distance_r[0]/c**2*pJy_pt_s
#                     Jefi_terms[6] = (z_o-z_s)/dr**3*rho_s
                    Jefi_terms[6] = (z_o-z_s)*distance_r[2]*rho_s
#                     Jefi_terms[7] = (z_o-z_s)/dr**2/c*prho_pt_s
                    Jefi_terms[7] = (z_o-z_s)*distance_r[1]/c*prho_pt_s
#                     Jefi_terms[8] = -1/dr/c**2*pJz_pt_s
                    Jefi_terms[8] = -distance_r[0]/c**2*pJz_pt_s
#                     Jefi_terms[9] = ((y_o-y_s)*Jz_s-(z_o-z_s)*Jy_s)/dr**3
                    Jefi_terms[9] = ((y_o-y_s)*Jz_s-(z_o-z_s)*Jy_s)*distance_r[2]
#                     Jefi_terms[10] = ((y_o-y_s)*pJz_pt_s-(z_o-z_s)*pJy_pt_s)/dr**2/c
                    Jefi_terms[10] = ((y_o-y_s)*pJz_pt_s-(z_o-z_s)*pJy_pt_s)*distance_r[1]/c
#                     Jefi_terms[11] = ((z_o-z_s)*Jx_s-(x_o-x_s)*Jz_s)/dr**3
                    Jefi_terms[11] = ((z_o-z_s)*Jx_s-(x_o-x_s)*Jz_s)*distance_r[2]
#                     Jefi_terms[12] = ((z_o-z_s)*pJx_pt_s-(x_o-x_s)*pJz_pt_s)/dr**2/c
                    Jefi_terms[12] = ((z_o-z_s)*pJx_pt_s-(x_o-x_s)*pJz_pt_s)*distance_r[1]/c
#                     Jefi_terms[13] = ((x_o-x_s)*Jy_s-(y_o-y_s)*Jx_s)/dr**3
                    Jefi_terms[13] = ((x_o-x_s)*Jy_s-(y_o-y_s)*Jx_s)*distance_r[2]
#                     Jefi_terms[14] = ((x_o-x_s)*pJy_pt_s-(y_o-y_s)*pJx_pt_s)/dr**2/c
                    Jefi_terms[14] = ((x_o-x_s)*pJy_pt_s-(y_o-y_s)*pJx_pt_s)*distance_r[1]/c
