    ...
    for ipx in range(px_grid_size):
        ...
        for ipy in range(py_grid_size):
            ...
            for ipz in range(pz_grid_size):
                ...
                if para >= 0.:
                    # only put the particles at z = 0
                    initial_distribution[6, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0g
                    initial_distribution[0, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0u
                    initial_distribution[1, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0d
                    initial_distribution[2, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0s
                    initial_distribution[3, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0ubar
                    initial_distribution[4, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0dbar
                    initial_distribution[5, 0, 0, int(z_grid_size/2),ipx, ipy, ipz] = f0sbar
...
import numpy as np
import math
def step_function_distribution(half_px_grid_size = 20,
                               half_py_grid_size = 20,
                               half_pz_grid_size = 20,
                               x_grid_size = 1,
                               y_grid_size = 1,
