...
class EMsolver():
    ...
    def Jefimenko_solver(self, rho, Jx, Jy, Jz, quasi_neutral):
        '''
...
#         print(rho, Jx, Jy, Jz)
        ...
        if quasi_neutral == 1:
            # calculate E and B
            Jefimenko_kernel_quasi_neutral[self.blockspergrid_o, self.threadsperblock](self.rho_GPU, self.Jx_GPU, self.Jy_GPU, self.Jz_GPU, \
...
#             print(self.len_time_snapshots, self.i_time, self.dt, self.t, \
#              self.total_grid_o, self.total_grid_s, \
#              self.x_grid_size_o, self.y_grid_size_o, self.z_grid_size_o, \
#              self.x_grid_size_s, self.y_grid_size_s, self.z_grid_size_s)
#             if self.time_tick % 500 == 0:
#                 print('rho, Jx')
#                 print(rho.max(), Jx.max())
