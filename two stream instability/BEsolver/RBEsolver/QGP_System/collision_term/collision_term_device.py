...
def collision_term_at_specific_point(f_x_p_t, flavor, collision_type,
                                     ...
                                     ix, iy, iz, ipx, ipy, ipz, dpx, dpy, dpz,
                                     p_type, g, dF, CA, CF, dA, Nq, Ng, mg_regulator_squared,
