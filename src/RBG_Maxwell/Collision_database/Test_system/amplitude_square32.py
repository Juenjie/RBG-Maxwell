...
def Amplitude_square(m1_squared,m2_squared,m3_squared,m4_squared,mp_squared,\
    ...
    I = math.sqrt((k40*p0-k4x*px-k4y*py-k4z*pz)**2-m4_squared*mp_squared*c**4)
    de = math.sqrt(k2x**2+k2y**2+k2z**2)
    if de < 10**(-13):
        return 0.
    else:
        if collision_type_indicator==0:
            ...
            return diff_cross*4*(2*math.pi)**5*k30*k10*I/(half_px[flavor[i_collision,0]]*half_py[flavor[i_collision,0]]*half_pz[flavor[i_collision,0]])/de
